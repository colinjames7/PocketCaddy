...
@SuppressLint("NewApi")
public class Player_Stat_Dialog extends DialogFragment
{
    ...
    private void showRound(Round round)
    {
            ...
            HorizontalScrollView horizontalscrollview = new HorizontalScrollView(view1.getContext());
    ...
    public void deletePlayer(View view2)
    {
    }
    ...
    public Dialog onCreateDialog(Bundle bundle)
    {
        ...
        view = (LinearLayout)view1.findViewById(R.id.player_stat_view);
        Button button;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            {
                this$0 = Player_Stat_Dialog.this;
            }
        });
        view.addView(button);
